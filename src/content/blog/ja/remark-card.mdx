...
fmContentType: blog
modifiedAt: 2024-11-26T08:42:45.816Z
category:
...
tags:
  ...
  slugList:
    ...
    - astro
    - markdown
description: 古来、我々はカードの形をしたものに目がない。プレーンテキストと並んでいるとどうしてもカードの方に目を奪われてしまう。しかし、マークダウンでは構文的にサポート外である。それならプラグインで拡張すればいいじゃない？
---
