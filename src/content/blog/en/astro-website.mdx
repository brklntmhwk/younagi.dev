...
modifiedAt: 2025-01-15T03:32:56.575Z
thumbnail: 🚀🌐🔧 ( •̀ᴗ•́ )و
---
...
Pining for the good old days, a lot of personal websites are going all out to add the ancient access counter while dragging their feet on a search window. While I think that's very cool, it's a different story here. [^1]
...
I've sort of accepted that we're destined to live with YouTube and amenably added a remark plugin for media frames.
