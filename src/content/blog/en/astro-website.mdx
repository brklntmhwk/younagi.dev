...
<BaseLayout
  ...
  og={{
    ...
    width: 1200,
    image: new URL(
      `/og/${locale}/${collection}/${slug.slice(slug.indexOf('/') + 1)}`,
      Astro.url
    ),
    type: 'article',
  }}
...
Finally, explicitly export and give it to
...
When I was into Next.js, my go-to hosting service was [Vercel](https://vercel.com/), but it felt like I needed to revisit it along with the transition to Astro. I came to a conclusion: [Cloudflare Pages](https://developers.cloudflare.com/pages/).
