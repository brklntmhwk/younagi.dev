...
tags:
  ...
  slugList:
    ...
    - pc
    - nixos
description: A newbie builds Mini-ITX PC. You'll learn some tricky points explained from the beginner's standpoint from parts selection to OS installation.
