...
fmContentType: blog
modifiedAt: 2024-09-05T03:26:33.406Z
category:
...
Notes contain the rest of all. They are supposed to be, so to speak, "Permanent Notes" down the road, following [the evergreen process](#the-evergreen-ethos).
...
> [!info]
> In NPKB, basically you're supposed to start with more specific and smaller notes like the "[Notes](#notes)" above.
...
- `🌲(Stage 4.evergreen forest):`  Well developed and full-fledged "Permanent Notes"
