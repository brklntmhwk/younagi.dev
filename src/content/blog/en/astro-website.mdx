...
Basically, I managed to develop it with what Astro offers. When it comes to some exceptions, I used [SolidJS](https://www.solidjs.com/), the up-and-coming JS framework. It goes without saying that all written in TypeScript (and TSX).
