...
modifiedAt: 2024-11-12T04:48:33.482Z
draft: published
type: blog
category:
...
> **スタイリング:** ~~[バニラCSS](https://www.w3.org/Style/CSS/Overview.en.html), [Vanilla Extract](https://vanilla-extract.style/)~~, [Tailwind CSS](https://tailwindcss.com/), [AstroのScoped CSS](https://docs.astro.build/en/guides/styling/#scoped-styles)
