...
fmContentType: blog
modifiedAt: 2025-01-15T00:30:39.542Z
category:
...
- Don't want to get bothered by tinkering with the numerous settings
...
- Have been around JavaScript, CSS, and Markdown for about four years
...
:::video[Create a new note in NPKB]
...
I feel like Obsidian is rather geared toward developers after using it for several years.

It's very customizable and you can build your ideal place depending on your ability and a combination of plugins.
That said, those with no dev experience will find it intimidating and expensive in its learning cost.
if you feel it's not right for you, you could migrate to [Notion](https://www.notion.so/), which is more widespread in general.

NPKB is based on a lot of great community plugins. With gratitude, here are some that play an integral role in it.
