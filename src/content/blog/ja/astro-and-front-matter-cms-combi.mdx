...
modifiedAt: 2024-11-21T06:38:17.256Z
---
...
そして驚くべきことに、[AIアシスタンス機能](https://frontmatter.codes/docs/sponsor-features#front-matter-ai)まで搭載している。
この機能は VSCode コマンドから呼び出し可能で、基本何でも聞ける。
...
大事なのは、コンテンツ用のディレクトリを Front Matter CMS 側で正確に指定することである。
...
ここまでの編集内容を踏まえ、私のダッシュボードはこのようになってる。
...
何かやりたいことがあった時に、アクセス手段が複数あるという点で、非常に快適だ。(例: スニペット機能はマークダウンパレットだけでなく VSCode コマンドからも呼び出せる)
