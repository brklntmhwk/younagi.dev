...
fmContentType: blog
modifiedAt: 2024-11-19T05:16:17.419Z
category:
...
- Install the pegboard to the wall in front
...
I thought it'd be enough to do so with connecting brackets but it turned out to be too optimistic. The connecting parts are wobbling like a guest in a club and it looks more like a trapezoid. I bought L-shaped corner brackets to stabilize them.
...
That was my first time to use a staple gun and to be honest, I was skeptical like "Does something that is merely superior to a stapler really have the ability to penetrate the dense OSB board?"
That turned out to be underestimation very soon.

![Nothing beats the staple gun, Yay!](../../../assets/images/diy-booth-staple-gun-power.jpg)
...
Who's going be convinced without any valid data? Me.
That said, I sort of collected data by using the free app "Decibel X" just in case, though I value subjective outcomes more than objective data this time.

The monitoring song is their hit song "Needled 24/7" from Children of Bodom and I used the first 20 seconds or so. I feel sorry to treat it as a noise, but it may be what it is for those who are not interested in metal music as a blanket term. [^4]

https://open.spotify.com/track/1aKrYw2i1mWRPMOUUe3dT8?si=1e65dc5163174e85

[^4]: I love it by the way.

Measure it three times for these situations:
...
As you can see, it has a huge soundproofing effect with only a door in between. As the distance between the sound source and the door is approximately shorter than 2 meter, it'd be okay to regard the attenuation effect caused by the distance as insignificant.
...
looks-unhealthy-for-body intense dramming kept so low a profile that noises made by a car running outside far away could easily obliterate them. In short, you can't hear it at midday unless you try to listen carefully.
