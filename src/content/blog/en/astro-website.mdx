...
modifiedAt: 2024-07-16T00:35:03.249Z
draft: published
type: blog
category:
...
- Want to build a website with Astro but have no idea how the whole project structure should be or what kind of features to be added
...
In my website, all contents are written in the Markdown/MDX format, but the basic syntax is limited to an absolute minimum.
...
> In reality, The [PageSpeed Insights](https://pagespeed.web.dev/) score of this page is so miserable.
> That's why I'm not going to use it that frequently though I put in a considerable amount of time creating it...
