...
更に、[AIアシスタンス機能](https://frontmatter.codes/docs/sponsor-features#front-matter-ai)まで有しています。この機能は VSCode コマンドから呼び出し可能で、何でも聞けます。つまり、調べものをするのにインターネット接続が不要になるのです。これはオフラインで記事が編集できるメリットと相まって、かなり魅力的ではないでしょうか。
