...
modifiedAt: 2024-11-12T04:45:59.576Z
draft: published
type: blog
category:
...
> **Styling:** ~~[Vanilla CSS](https://www.w3.org/Style/CSS/Overview.en.html), [Vanilla Extract](https://vanilla-extract.style/)~~, [Tailwind CSS](https://tailwindcss.com/), [Astro's Scoped CSS](https://docs.astro.build/en/guides/styling/#scoped-styles)
