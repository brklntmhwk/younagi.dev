...
tags:
  ...
  slugList:
    - keyboard
modifiedAt: 2025-01-07T08:12:59.368Z
...
Simultaneously, I got to know there are bunches of keyboard layouts out there motivated by this spirit──  Emancipation from the QWERTY-dominant world.
...
- `<>`: There's no space for them so they're assinged to other layer(Will be mentioned later)
...
Luckily, it's still early days for me as a Vimmer and the key bindings are still growing day by day; therefore it seems somehow easier to act as a go-between.
