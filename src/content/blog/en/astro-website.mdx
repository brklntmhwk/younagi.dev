...
OG Images are dynamically generated via the API endpoint functionality Astro provides. To make it simpler, I installed the `astro-og-canvas` library and used it like this.
