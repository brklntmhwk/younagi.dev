...
fmContentType: blog
modifiedAt: 2024-11-25T05:57:56.517Z
category:
...
What's nice about "The Endpoint" is, it offers 4 optional areas where you can install a trackball. They are the index finger and the thumb positions from both left and right.
...
I ended up starting it over and over about 10 times and wasting 100mm or so of the solder wick.

> [!info]
> If your trackball doesn't move the mouse cursor at all, check if this soldering is done properly first.
