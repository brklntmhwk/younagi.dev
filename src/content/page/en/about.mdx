...
title: about
type: page
modifiedAt: 2024-12-19T08:52:56.369Z
---
...
What have I built this website for? I'm at a loss for the answer but it's at least not for such a wonderful purpose as aspiration for world peace. Neither is it for conveying my voice to the public.

It might boil down to "Hitori sumo". That said, it'd be nice if anyone else enjoys what I do in the end.
...
Articles categorized as "[Learning](https://younagi.dev/blog/categories/learning/)" or "[Attempt](https://younagi.dev/blog/categories/attempt/)" have a "Level" field indicated as five stars. Bear in mind that this is totally based on my subjective judgment considering the criteria below.
...
By and large, I love abstract stuff──that said, I love something extremely concrete too.
Likening it to music, both esoteric jazz and hip hop music with real-sounding lyrics are my favorites.
