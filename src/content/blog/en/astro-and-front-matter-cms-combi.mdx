...
modifiedAt: 2024-07-22T08:22:55.835Z
---
...
For the same reason, I've been using [Obsidian](https://obsidian.md/) as my knowledge base and [Astro](https://astro.build/) as a JS framework of this website. The common ground is "**portability**".
